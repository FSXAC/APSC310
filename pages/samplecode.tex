...
\lstinputlisting[language=C++, firstline=14, lastline=20]{code/Flyweight.hpp}
...
\lstinputlisting[language=C++, firstline=23, lastline=36]{code/Flyweight.hpp}
\subsubsection{Flyweight Creation and Logic}
The flyweights creation are managed by a simple factory.
\lstinputlisting[language=C++, firstline=38, lastline=66]{code/Flyweight.hpp}
...
\lstinputlisting[language=C++, firstline=3, lastline=11]{code/Flyweight.hpp}
\subsubsection{Usage}
Example of how to use the design pattern.
\lstinputlisting[language=C++, firstline=69, lastline=88]{code/Flyweight.hpp}
