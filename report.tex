...
\begin{figure}[!ht]
	...
	\scalebox{0.5}{
		\begin{tikzpicture}
			...
			\begin{class}{ConcreteFactory1}{3, -4}
				...
				\operation{+ CreateProductB () }
			\end{class}
			\begin{class}{AbstractProductA}{15 , -2}
			\end{class}
			\begin{class}{ProductA1}{12 , -4}
				\implement{AbstractProductA}
			\end{class}
			\begin{class}{ProductA2}{18 , -4}
				\implement{AbstractProductA}
			\end{class}
			...
			\begin{class}{AbstractProductB}{15 , -8}
			\end{class}
	...
	\caption{A generic UML diagram of abstract factory pattern}
